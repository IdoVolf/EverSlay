...
def PassiveBuffs(player,window):
    ...
    buffsAssets1 = [pygame.image.load(resource_path(f"assets/buffs/buff{i}1.png")) for i in range(1,5)]
    buffsAssets2 = [pygame.image.load(resource_path(f"assets/buffs/buff{i}2.png")) for i in range(1,5)]
